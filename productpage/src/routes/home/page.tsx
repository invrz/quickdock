  ...
  return (
    <>
      <div className="page-view" style={{ background: 'var(--high-contrast-bg)' }}>
        ...
        {/* Testimonials */}
        <section id="testimonials" className="grid-row gutter-width-5 col-width-15 row-center bg-accent-dark" style={{ padding: '4rem 2rem'}}>
          <div className="col-width-12">
        ...
        <footer className="grid-row col-width-12 row-middle row-center padding--small" style={{background: 'var(--high-contrast-bg)' }}>
          <nav className="col-width-10 col-width-15-sm" style={{ color: 'var(--high-contrast-text)' }}>
            <a className="text-body text--no-decoration" href="#hero">Hero</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a className="text-body text--no-decoration" href="#about">About</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a className="text-body text--no-decoration" href="#features">Features</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a className="text-body text--no-decoration" href="#testimonials">Testimonials</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a className="text-body text--no-decoration" href="#download">Download</a>
          </nav>
